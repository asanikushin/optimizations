...
def main():
    ...
    if file:
        ...
        print('<!DOCTYPE HTML><html><head>'
              ...
              '<script type="text/javascript" src="http://latex.codecogs.com/latexit.js"></script></head><body>',
              file=file)
        ...
        print(
            f'<b>Точность (<img src="http://latex.codecogs.com/svg.latex?\\epsilon" border="0"/>) вычислений методов: '
        ...
        print(
            f'<b>Начальная длина шага для оптимизации (<img src="http://latex.codecogs.com/svg.latex?L_0" border="0"/>): '
